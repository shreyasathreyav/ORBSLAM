...
KeyFrame::KeyFrame():
        ...
        mnMaxY(0), mPrevKF(static_cast<std::shared_ptr<KeyFrame>>(NULL)), mNextKF(static_cast<std::shared_ptr<KeyFrame>>(NULL)), mbFirstConnection(true), mpParent(NULL), mbNotErase(false),
