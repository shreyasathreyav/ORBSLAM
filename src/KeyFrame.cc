...
KeyFrame::KeyFrame():
        ...
        NLeft(0),NRight(0), mnNumberOfOpt(0), mbHasVelocity(false), mReferencecount(0),mReferencecount_mob(0)
{
...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    mvKeysRight(F.mvKeysRight), NLeft(F.Nleft), NRight(F.Nright), mTrl(F.GetRelativePoseTrl()), mnNumberOfOpt(0), mbHasVelocity(false), mReferencecount(0), mReferencecount_mob(0)
{
    mnId=nNextId++;
