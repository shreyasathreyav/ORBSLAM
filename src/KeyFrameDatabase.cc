...
// Increment for pBestKF
            ...
            // }
            {
                ...
                //     pBestKF->thread_id_collection_map.end())
                {
                    ...
                    if (checker_thread_id == pBestKF->tracking_thread_id)
                    {

                        pBestKF->tracking_count++;
                    }
                    else if (checker_thread_id == pBestKF->local_mapping_thread_id)
                    {

                        pBestKF->local_mapping_count++;
                    }
                    else if (checker_thread_id == pBestKF->loop_closing_thread_id)
                    {

                        pBestKF->loop_closing_count++;
                    }
                    else
                    {

                        pBestKF->viewer_count++;
                    }
                }
                // else
                // {
                ...
                //     itr.second->thread_id_collection_map.end())
                {
                    ...
                    // itr.second->thread_id_collection_map[this_thread::get_id()]--;
                    {

                        {
                            ...
                            std::thread::id checker_thread_id = this_thread::get_id();
                            if (checker_thread_id == itr.second->tracking_thread_id)
                            {

                                itr.second->tracking_count--;
                            }
                            else if (checker_thread_id == itr.second->local_mapping_thread_id)
                            {

                                itr.second->local_mapping_count--;
                            }
                            else if (checker_thread_id == itr.second->loop_closing_thread_id)
                            {

                                itr.second->loop_closing_count--;
                            }
                            else
                            {

                                itr.second->viewer_count--;
                            }
                        }
                    }
                }
