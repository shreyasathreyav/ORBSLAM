      ...
      mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    mpLocalMapper->tracking_thread_id = tracking_thread_id;
    mpLocalMapper->local_mapping_thread_id = local_mapping_thread_id;
    mpLocalMapper->loop_closing_thread_id = loop_closing_thread_id;
