...
namespace ORB_SLAM3
{
    ...
    // {
    //     // Edge-SLAM: debug
    //     //cout << "log,LocalMapping::ProcessNewKeyFrame,start" << "\n";
    //     shared_lock lock(mpAtlas->mpCurrentMap->mMutexKFMPDeletion);

    //     {
    //         unique_lock<mutex> lock(mMutexNewKFs);
    //         mpCurrentKeyFrame = mlNewKeyFrames.front();
    //         mpCurrentKeyFrameID = mpCurrentKeyFrame->mnId;
    ...
    //     {
    //        mpAtlas->mpCurrentMap->mvpKeyFrameOrigins.push_back(mpCurrentKeyFrame);
    //     }
    ...
    //                 {
    //                     KeyFrame* pRefKF = mpAtlas->mpCurrentMap->RetrieveKeyFrame(pMP->mnFirstKFid);
    //                     if(pRefKF != nullptr)
    //                     {
    ...
    //                     {
    //                         // Edge-SLAM: debug
    //                         //cout << "log,LocalMapping::ProcessNewKeyFrame,mappoint mnFirstKFid not found" << "\n";
    ...
    //                     {
    //                         newMP = mpAtlas->mpCurrentMap->RetrieveMapPoint(pMP->lmMnId, false);
    //                     }
    //                     else // If local mapping id is not set, we try to find the mappoint by tracking id
    //                     {
    //                         newMP = mpAtlas->mpCurrentMap->RetrieveMapPoint(pMP->mnId, true);
    //                     }

    //                     if (newMP != nullptr) // If it has not been removed and its available in the global map
    //                     {
    //                         newMP->AddObservation(mpCurrentKeyFrame, i);
    //                         newMP->UpdateNormalAndDepth();
    // -
    //                         newMP->ComputeDistinctiveDescriptors();

    //                         // Add the corresponding address in global map
    //                         mpCurrentKeyFrame->AddMapPoint(newMP, i);
    //                     }
    //                     else
    //                     {
    ...
    //                     mlpRecentAddedMapPoints.insert(std::make_pair(pMP->GetId(), pMP));

    //                     mpAtlas->mpCurrentMap->AddMapPoint(pMP); // Since we have a separate map from tracking map
    //                     pMP->setMapPointer(mpAtlas->mpCurrentMap); // We are not sending the map pointer in marshalling
    //                 }
    //             }
    //         }
    //     }
    ...
    //     // Atlas: added bool isTracking
    //     mpAtlas->mpCurrentMap->AddKeyFrame(mpCurrentKeyFrame, false);
    // }
    ...
    void LocalMapping::MapPointCulling()
    {
        ...
        while (lit != mlpRecentAddedMapPoints.end())
        {
            ...
            ================
            check edgeslam.
            Also why not deleteing pointers which are erase below.
            ==================
            */
            if (pMP->isBad())
            ...
            {
                // pMP->SetBadFlag();
                mpAtlas->mpCurrentMap->EraseMapPoint(pMP);
                lit = mlpRecentAddedMapPoints.erase(lit);
            }
